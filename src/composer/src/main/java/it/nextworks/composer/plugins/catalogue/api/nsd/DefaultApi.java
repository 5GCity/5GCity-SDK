...
import it.nextworks.composer.plugins.catalogue.elements.nsd.ProblemDetails;
...
public class DefaultApi {
	...
	/**
	 * Create NSD Info The POST method is used to create a new NS descriptor
	 * resource. This method shall follow the provisions specified in the Tables
	 * 5.4.2.3.1-1 and 5.4.2.3.1-2 of GS NFV-SOL 005 for URI query parameters,
	...
	/**
	 * Create PNFD Info The POST method is used to create a new PNF descriptor
	 * resource.
	 * <p>
	 * <b>201</b> - Status 201
	 * <p>
	 ...
	 * response codes, as specified in the Tables 5.4.8.3.1-1 and 5.4.8.3.1-2 of
	 * GS-NFV SOL 005. Creation of two subscription resources with the same
	 ...
	 * Created\&quot; response code), or may decide to not create a duplicate
	 * subscription resource (in which case it shall return a \&quot;303 See
	 * Other\&quot; response code referencing the existing subscription resource
	 * with the same filter and callbackUri).
	 * <p>
	 * <b>201</b> - Status 201
	 * <p>
	 * <b>303</b> - A subscription with the same callbackURI and the same filter
	...
	/**
	 * Delete NSD The DELETE method deletes an individual NS descriptor resource. An
	 * individual NS descriptor resource can only be deleted when there is no NS
	 * instance using it (i.e. usageState &#x3D; NOT_IN_USE) and has been disabled
	 ...
	 * request and response data structures, and response codes.
	 * <p>
	 * <b>204</b> - The operation has completed successfully. The response body
	 * shall be empty.
	 * <p>
	 * <b>404</b> - Status 404
	 * <p>
	...
	/**
	 * Delete PNFD The DELETE method deletes an individual PNF descriptor resource.
	 * An individual PNF descriptor resource can only be deleted when there is no NS
	 ...
	 * in this clause to delete each PNFD version individually. This method shall
	 * follow the provisions specified in the Tables 5.4.6.3.5-1 and 5.4.6.3.5-2 of
	 * GS NFV-SOL 005 for URI query parameters, request and response data
	...
	/**
	 * Terminate Subscription The DELETE method terminates an individual
	 * subscription. This method shall support the URI query parameters, request and
	 * response data structures, and response codes, as specified in the Tables
	 * 5.4.9.3.5-1 and 5.4.9.3.3-2 of GS NFV-SOL 005.
	 * <p>
	 * <b>204</b> - The subscription resource was deleted successfully. The response
	 * body shall be empty.
	 * <p>
	 * <b>400</b> - Status 400
	 * <p>
	...
	public void deleteSubscription(String subscriptionId) throws RestClientException {
		...
		String path = UriComponentsBuilder.fromPath("/nsd/v1/subscriptions/{subscriptionId}")
	...
	/**
	 * Get NSD Content The GET method fetches the content of the NSD. The NSD can be
	 * implemented as a single file or as a collection of multiple files. If the NSD
	 * is implemented in the form of multiple files, a ZIP file embedding these
	 * files shall be returned. If the NSD is implemented as a single file, either
	 * that file or a ZIP file embedding that file shall be returned. The selection
	 * of the format is controlled by the \&quot;Accept\&quot; HTTP header passed in
	 * the GET request: • If the \&quot;Accept\&quot; header contains only
	 ...
	 * <p>
	 * <b>200</b> - On success, the content of the NSD is returned. The payload body
	 * shall contain a copy of the file representing the NSD or a ZIP file that
	 * contains the file or multiple files representing the NSD, as specified above.
	 ...
	 * <p>
	 * <b>206</b> - On success, if the NFVO supports range requests, a single
	 * consecutive byte range from the content of the NSD file is returned. The
	 * response body shall contain the requested part of the NSD file. The
	 * \&quot;Content-Range\&quot; HTTP header shall be provided according to IETF
	 * RFC 7233 [23]. The \&quot;Content-Type\&quot; HTTP header shall be set as
	...
	/**
	 * Query NSD Info The GET method reads information about an individual NS
	 * descriptor. This method shall follow the provisions specified in GS NFV-SOL
	 * 005 Tables 5.4.3.3.2-1 and 5.4.3.3.2-2 of GS NFV-SOL 005 for URI query
	 * parameters, request and response data structures, and response codes.
	 * <p>
	 * <b>200</b> - Information about the individual NS descriptor. The response
	 * body shall contain a representation of the individual NS descriptor, as
	...
	/**
	 * Query NSDs Info The GET method queries information about multiple NS
	 * descriptor resources. This method shall follow the provisions specified in
	 * the Tables 5.4.2.3.2-1 and 5.4.2.3.2-2 of GS NFV-SOL 005 for URI query
	 * parameters, request and response data structures, and response codes.
	 * <p>
	 * <b>200</b> - Information about zero or more NS descriptors. The response body
	 * shall contain a representation of zero or more NS descriptors, as defined in
	 * clause 5.5.2.2 of GS NFV-SOL 005.
	 * <p>
	 * <b>400</b> - There are two possible scenarios listed below. Error: Invalid
	 * attribute-based filtering parameters. The response body shall contain a
	 * ProblemDetails structure, in which the \&quot;detail\&quot; attribute should
	 * convey more information about the error. Error: Invalid attribute selector.
	 * The response body shall contain a ProblemDetails structure, in which the
	 * \&quot;detail\&quot; attribute should convey more information about the
	 * error.
	 * <p>
	 * <b>500</b> - Status 500
	 * 
	...
	/**
	 * Get PNFD Content The GET method fetches the content of the PNFD.
	 * <p>
	 * <b>200</b> - On success, the content of the PNFD is returned. The payload
	 * body shall contain a copy of the file representing the PNFD. The
	 * \&quot;Content-Type\&quot; HTTP header shall be set to
	 * \&quot;text/plain\&quot;.
	 * <p>
	 * <b>400</b> - Status 400
	 * <p>
	...
	/**
	 * Query PNFD Info The GET method reads information about an individual PNF
	 * descriptor. This method shall follow the provisions specified in the Tables
	 * 5.4.6.3.2-1 and 5.4.6.3.2-2 of GS NFV-SOL 005 for URI query parameters,
	 * request and response data structures, and response codes.
	 * <p>
	 * <b>200</b> - Information about the individual PNFD descriptor. The response
	 * body shall contain a representation of the individual PNF descriptor, as
	...
	/**
	 * Query PFNDs Info The GET method queries information about multiple PNF
	 ...
	 * <b>500</b> - Status 500
	 * 
	 * @param excludeDefault Indicates to exclude the following complex attributes
	 *                       from the response. See clause 4.3.3 for details. The
	 *                       NFVO shall support this parameter. The following
	 *                       attributes shall be excluded from the PnfdInfo
	 *                       structure in the response body if this parameter is
	 *                       provided, or none of the parameters
	 *                       \&quot;all_fields,\&quot; \&quot;fields\&quot;,
	 *                       \&quot;exclude_fields\&quot;,
	 *                       \&quot;exclude_default\&quot; are provided:
	 *                       userDefinedData.
	 * @param allFields      Include all complex attributes in the response. See
	 *                       clause 4.3.3 for details. The NFVO shall support this
	 *                       parameter.
	...
	/**
	 * Query Subscription Information The GET method retrieves information about a
	 * subscription by reading an individual subscription resource. This method
	 * shall support the URI query parameters, request and response data structures,
	 * and response codes, as specified in the Tables 5.4.9.3.2-1 and 5.4.9.3.2-2.
	 * <p>
	 * <b>200</b> - Status 200
	 * <p>
	 * <b>400</b> - Status 400
	 ...
	 * e.g. for resynchronization after error situations. This method shall support
	 * the URI query parameters, request and response data structures, and response
	 * codes, as specified in the Tables 5.4.8.3.2-1 and 5.4.8.3.2-2 of GS NFV-SOL
	 * 005.
	 * <p>
	 * <b>200</b> - Status 200
	 * <p>
	...
	/**
	 * Update NSD Info The PATCH method modifies the operational state and/or user
	 * defined data of an individual NS descriptor resource. This method can be used
	 * to: 1) Enable a previously disabled individual NS descriptor resource,
	 * allowing again its use for instantiation of new network service with this
	 * descriptor. The usage state (i.e. \&quot;IN_USE/NOT_IN_USE\&quot;) shall not
	 * change as a result. 2) Disable a previously enabled individual NS descriptor
	 * resource, preventing any further use for instantiation of new network
	 * service(s) with this descriptor. The usage state (i.e.
	 * \&quot;IN_USE/NOT_IN_USE\&quot;) shall not change as a result. 3) Modify the
	 * user defined data of an individual NS descriptor resource. This method shall
	 * follow the provisions specified in the Tables 5.4.3.3.4-1 and 5.4.3.3.4-2 for
	...
	/**
	 * Update PNFD Info The PATCH method modifies the user defined data of an
	 * individual PNF descriptor resource. This method shall follow the provisions
	 * specified in the Tables 5.4.6.3.4-1 and 5.4.6.3.4-2 for URI query parameters,
	 * request and response data structures, and response codes.
	 * <p>
	 * <b>200</b> - Status 200
	 * <p>
	...
	/**
	 * Upload NSD The PUT method is used to upload the content of a NSD. The NSD to
	 * be uploaded can be implemented as a single file or as a collection of
	 * multiple files, as defined in clause 5.4.4.3.2 of GS NFV-SOL 005. If the NSD
	 * is implemented in the form of multiple files, a ZIP file embedding these
	 * files shall be uploaded. If the NSD is implemented as a single file, either
	 * that file or a ZIP file embedding that file shall be uploaded. The
	 ...
	 * <b>202</b> - Status 202
	 * <p>
	 * <b>204</b> - The NSD content was successfully uploaded and validated
	 * (synchronous mode). The response body shall be empty.
	 * <p>
	 * <b>400</b> - Status 400
	 * <p>
	 * <b>404</b> - Status 404
	 * <p>
	 * <b>409</b> - Error: The operation cannot be executed currently, due to a
	 * conflict with the state of the resource. Typically, this is due to the fact
	 * that the NsdOnboardingState has a value other than CREATED. The response body
	 ...
	 * @param nsdInfoId   The nsdInfoId parameter
	 * @param body        The body parameter
	 * @param contentType The payload body contains a copy of the file representing
	 *                    the NSD or a ZIP file that contains the file or multiple
	 *                    files representing the NSD, as specified above. The
	 *                    request shall set the \&quot;Content-Type\&quot; HTTP
	...
	/**
	 * Upload PNFD The PUT method is used to upload the content of a PNFD. This
	 * method shall follow the provisions specified in the Tables 5.4.7.3.3-1 and
	 * 5.4.7.3.3-2 of GS NFV-SOL 005for URI query parameters, request and response
	 * data structures, and response codes.
	 * <p>
	 * <b>204</b> - The PNFD content was successfully uploaded and validated. The
	 ...
	 * @param pnfdInfoId  The pnfdInfoId parameter
	 * @param body        The body parameter
	 * @param contentType The request shall set the \&quot;Content-Type\&quot; HTTP
