 ...
 */
package it.nextworks.composer.plugins.catalogue.invoker.vnf;

import it.nextworks.composer.plugins.catalogue.Catalogue;
import it.nextworks.composer.plugins.catalogue.invoker.vnf.auth.ApiKeyAuth;
import it.nextworks.composer.plugins.catalogue.invoker.vnf.auth.Authentication;
import it.nextworks.composer.plugins.catalogue.invoker.vnf.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    public ApiClient(Catalogue catalogue) {
    ...
    public Object invokeApi(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, String authorization) throws RestClientException {
        File tempFile = null;
