 ...
 */
package it.nextworks.composer.plugins.catalogue.invoker.management;

import it.nextworks.composer.plugins.catalogue.Catalogue;
import it.nextworks.composer.plugins.catalogue.invoker.management.auth.ApiKeyAuth;
import it.nextworks.composer.plugins.catalogue.invoker.management.auth.Authentication;
import it.nextworks.composer.plugins.catalogue.invoker.management.auth.HttpBasicAuth;
import it.nextworks.composer.plugins.catalogue.invoker.management.auth.OAuth;
