...
public class FunctionInstanceRestController {
	...
	@RequestMapping(value = "/functions/instances/{functionId}", method = RequestMethod.GET)
	public ResponseEntity<?> getFunctionInstance(@PathVariable Long functionId) {
	...
	@RequestMapping(value = "/functions/instances", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/functions/{functionId}/instances", method = RequestMethod.GET)
	public ResponseEntity<?> getFunctionInstancesPerFunction(@PathVariable Long functionId) {
		log.info("Request for get FUNCTIONS");
		List<SDKFunctionInstance> response = new ArrayList<>();
	...
	@RequestMapping(value = "/functions/instances/{functionId}/monitoringparams", method = RequestMethod.PUT)
	public ResponseEntity<?> updateMonitoringParametersForFunction(@PathVariable Long functionId, @RequestBody List<MonitoringParameter> monitoringParameters) {
	...
	@RequestMapping(value = "/functions/instances/{functionId}/monitoringparams", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/functions/instances/{functionId}/monitoringparams", method = RequestMethod.DELETE)
	public ResponseEntity<?> deleteMonitoringParametersForFunction(@PathVariable Long functionId, @RequestBody List<MonitoringParameter> monitoringParameters) {
	...
	@RequestMapping(value = "/functions/instances/{functionId}/flavour", method = RequestMethod.PUT)
	public ResponseEntity<?> updateFlavourForFunction(@PathVariable Long functionId, @RequestBody Flavour flavour) {
